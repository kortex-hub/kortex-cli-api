...
#[doc = "  \"properties\": {"]
#[doc = "    \"description\": {"]
#[doc = "      \"description\": \"Human-readable description of the workspace.\","]
#[doc = "      \"type\": \"string\","]
#[doc = "      \"maxLength\": 500"]
#[doc = "    },"]
#[doc = "    \"environment\": {"]
...
pub struct WorkspaceConfiguration {
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub description: ::std::option::Option<WorkspaceConfigurationDescription>,
    #[serde(default, skip_serializing_if = "::std::vec::Vec::is_empty")]
...
#[serde(transparent)]
pub struct WorkspaceConfigurationDescription(::std::string::String);
impl ::std::ops::Deref for WorkspaceConfigurationDescription {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<WorkspaceConfigurationDescription> for ::std::string::String {
    fn from(value: WorkspaceConfigurationDescription) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for WorkspaceConfigurationDescription {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for WorkspaceConfigurationDescription {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for WorkspaceConfigurationDescription {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for WorkspaceConfigurationDescription {
...
pub mod builder {
    ...
    pub struct WorkspaceConfiguration {
        description: ::std::result::Result<
            ::std::option::Option<super::WorkspaceConfigurationDescription>,
            ::std::string::String,
        >,
